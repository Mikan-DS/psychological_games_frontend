          ...
          <div id="FAQ" style={{paddingTop: 100, paddingBottom: 100}}>
              <div style={{width: 1400, marginLeft: "auto", marginRight: "auto"}}>
                  ...
                  <ToggleQuestion question="Сколько времени потребуется на прохождение игры?">
                      <p>
                          В среднем для прохождения игры нужно 40-60 минут, при вдумчивом прохождении до полутора часов.
                  ...
                  <ToggleQuestion question="Как узнать, что мой ребёнок стал жертвой буллинга?">
                      <p>
                          ...
                          Также важно поддерживать открытую линию общения, чтобы ребёнок мог делиться своими проблемами.
                      </p>
                  </ToggleQuestion>
                  <ToggleQuestion
                  ...
                  <ToggleQuestion
                      ...
                      <p>
                          ...
                          <ul>
                              ...
                              <li>Коммуникация с родителями и учениками: Проведение встреч с родителями и учениками для
                              ...
                              <li>Организация классных мероприятий: Разработка и проведение классных часов и дискуссий
                                  на тему буллинга, например, просмотр фильмов и мультфильмов по этой теме с последующим
                                  их разбором.
                              </li>
                          </ul>
                          Школьный психолог:
                          ...
                          Администрация школы:
                          <ul>
                              <li>Предоставление информации и ресурсов: Информирование родителей о доступных ресурсах и
                                  методиках поддержки.
                              </li>
                              ...
                              <li>Осознание границ своей компетентности и ответственности за события в школе: в случае,
                                  если ситуация выходит из-под контроля, самим обратиться в правоохранительные органы за
                                  помощью.
                              </li>
                          </ul>
                      </p>
                  ...
                  <ToggleQuestion
                      ...
                      <p>
                          ...
                          Объясните, что вмешательство может быть разным — от прямой защиты до поиска помощи у взрослых.
