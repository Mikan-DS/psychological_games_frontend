    ...
    return (
        <div id="FAQ" className={"faq"}>
            <div className={"content-box"}>
                ...
                <hr/>
                <ToggleQuestion question="Для каких устройств создана игра?">

                    Игра «Классные джунгли» запускается на любых устройствах,
                    но мы рекомендуем устройства с высокоскоростным интернетом.
                    На смартфонах с низкой скоростью интернета, первая загрузка может достигать 6-8 минут.
                    Для удобства игры на смартфонах расположите их горизонтально
                    и в «Настройках» включите полноэкранный режим.
                </ToggleQuestion>
