...
export default function CoverSection({user, loginModalControl, playAction}){
    ...
    return (
        <div className={"СoverSection"} style={{backgroundImage: "url(" + Cover + ")"}}>

            <header className={"ContentBox"}>
                <div className={"Stretched align-center"}>
            ...
            <div className={"ContentBox"}>
                <div className={"Stretched"}>
                    ...
                    <div className={"VerticalBox align-right cover-description-box only-desktop"}>
                ...
                <img className={"ContentBox only-desktop"} src={CoverPics ? CoverPics : ""} alt="Фоны игры"/>
                <img className={"ContentBox only-mobile"} src={CoverPicsMobile ? CoverPicsMobile : ""} alt="Фоны игры"/>

                <div className={"VerticalBox align-right cover-description-box only-mobile"}>
                    <div className={"accent-text2 cover-description-text"}>
                        Психологическая компьютерная игра
                        <br/>
                        Проблемы школьного буллинга
                    ...
                    <div className={"align-center cover-play-box"}>
                        <img className={"age-image"} src={AgeImage ? AgeImage : ""} alt="12+"/>
                        <button className={"primary-button-medium"} onClick={playAction}>
                            ИГРАТЬ
                        </button>
                    </div>
                </div>
